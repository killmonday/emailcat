...
func (v *Verifier) CheckSMTP(domain, username string, sport string) (*SMTP, error) {
	...
	client, err := newSMTPClient(domain, v.proxyURI, sport)
	if err != nil {
...
func newSMTPClient(domain, proxyURI string, sport string) (*smtp.Client, error) {
